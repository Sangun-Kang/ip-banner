(()=>{var d=(p,r)=>()=>(r||p((r={exports:{}}).exports,r),r.exports);var s=d(()=>{(function(p){let r={backgroundColor:"#003366",textColor:"#ffffff",fontFamily:"sans-serif",iconUrl:"",description:"Your public IP:",height:"2.5em",top:"0",zIndex:9999,ipPosition:"suffix",ipSpacing:8,iconSpacing:8,fontSize:"14px"};function c(a,t){let n={...a};for(let i in t)t[i]!=null&&(n[i]=t[i]);return n}function l(a={}){let t=c(r,a),n=document.createElement("div");if(n.id="ip-banner",Object.assign(n.style,{position:"fixed",top:t.top,left:0,width:"100%",height:t.height,lineHeight:t.height,backgroundColor:t.backgroundColor,color:t.textColor,fontFamily:t.fontFamily,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 1em",boxSizing:"border-box",zIndex:t.zIndex}),n.style.cssText+=`
      position: fixed !important;
      top: ${t.top} !important;
      left: 0 !important;
      width: 100% !important;
      height: ${t.height} !important;
      line-height: ${t.height} !important;
